...
SECRET_KEY = os.getenv('SOPDS_SECRET_KEY', '')
...
#    ('SOPDS_TELEBOT_LOG', (os.path.join(BASE_DIR, 'opds_catalog/log/sopds_telebot.log'), _('Path to logfile for sopds_telebot process'))),
    ('SOPDS_SERVER_LOG', ('/config/log/sopds-server.log',_('Path to logfile for sopds_server process'))),
    ('SOPDS_SCANNER_LOG', ('/config/log/sopds-scanner.log',_('Path to logfile for sopds_scanner process'))),
    ('SOPDS_TELEBOT_LOG', ('/config/log/sopds-telebot.log', _('Path to logfile for sopds_telebot process'))),
